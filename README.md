...
| 命令                                                                  | 说明                                                                                                                                |
| :-------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------- |
| `/生图 <预设/人设...> [额外提示词] [数量]` 或 `/生图 <提示词> [数量]` | 生成图片。开头连续命中的预设/人设会依次应用；多来源提示词会按“人物设定 / 预设提示词 / 附加提示词”分块发送；末尾单独数字表示生成数量；消息、引用消息、@ 用户或人设参考图会作为参考图。 |
...
| 最大并发完整生图任务数 | 1      | 同时运行的完整生图任务数量上限；超过后任务会保持排队，不会开始参考图转换或模型调用。           |
